...
def main(n_runs: int):
    ...
    for i, combination in enumerate(tqdm.tqdm(combinations, desc='Experiments', leave=False)):
        ...
        valid_noise = [syn_signals.RealSignal.Type.FLOW,
        ...
        for _ in tqdm.tqdm(range(n_runs), leave=False, desc="Run"):
            ...
            noise_types = random.sample(valid_noise, 2)

            signal1=syn_signals.RealSignal(type=noise_types[0])
            signal2=syn_signals.RealSignal(type=noise_types[1])
