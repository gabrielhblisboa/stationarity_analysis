...
def calculate_kl(noise, num_samples, noise_color, noise_var, sub_dir, pdf_type='std',
    ...
    if est_type == 'kl':
        ...
        ax[1][0].set_title('Wasserstein Between Blocks')
    elif est_type == 'jensen-shannon':
        ax[1][0].set_ylabel('JS Divergence')
        ax[1][0].set_title('JS Divergence Between Blocks')
    ...
    if est_type == 'kl':
        ...
        ax[1][1].set_title('Wasserstein Progression Between Blocks')
    elif est_type == 'jensen-shannon':
        ax[1][1].set_ylabel('JS Divergence')
        ax[1][1].set_title('JS Divergence Progression Between Blocks')
    ...
    if est_type == 'kl':
        ...
        ax[2][0].set_title('Wasserstein Between Inverted Blocks')
    elif est_type == 'jensen-shannon':
        ax[2][0].set_ylabel('JS Divergence')
        ax[2][0].set_title('JS Divergence Between Inverted Blocks')
    ...
    if est_type == 'kl':
        ...
        ax[2][1].set_title('Wasserstein Accumulating Inverted Blocks')
    elif est_type == 'jensen-shannon':
        ax[2][1].set_ylabel('JS Divergence')
        ax[2][1].set_title('JS Divergence Accumulating Inverted Blocks')
